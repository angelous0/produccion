  ...
  return (
    <div className="space-y-5" data-testid="dashboard">
      ...
      <div className="grid gap-3 grid-cols-2 lg:grid-cols-4">
        <Card className="cursor-pointer hover:shadow-md transition-shadow hover:border-primary/40" onClick={() => navigate('/reportes/seguimiento')} data-testid="kpi-en-proceso">
        ...
        <Card className="cursor-pointer hover:shadow-md transition-shadow hover:border-destructive/40" onClick={() => navigate('/reportes/seguimiento?tab=atrasados')} data-testid="kpi-atrasados">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-3xl font-bold tracking-tight text-red-600">{dashboard?.atrasados || 0}</p>
            <p className="text-xs text-muted-foreground mt-1">requieren atencion</p>
          </CardContent>
        </Card>
        <Card data-testid="kpi-movs">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
      ...
      {alertas && alertas.resumen?.total > 0 && (
        <Card className="border-red-200 bg-red-50/30 dark:bg-red-950/10" data-testid="dashboard-alertas">
          ...
          <CardContent className="px-4 pb-3 pt-1">
            <div className="grid gap-1.5 sm:grid-cols-2 lg:grid-cols-3">
              {alertas.alertas.slice(0, 6).map((a) => (
                <div key={a.movimiento_id} className="flex items-center gap-2 p-2 rounded-md border bg-white dark:bg-zinc-900 hover:shadow-sm cursor-pointer transition-all text-sm"
